...
public class novoLivroController {
	...
	@PostMapping
	public ResponseEntity<novoLivroDTO> cadastra (@RequestBody @Valid novoLivroForm form, UriComponentsBuilder uriBuilder){
	...
	@GetMapping
	public ResponseEntity<List<novoLivro>> GetAll(){ 
